      ...
      <div ref={ref}>
        {userData.avatar && !avatarFailed ? (
          ...
          />
           ...
           <svg xmlns="http://www.w3.org/2000/svg" className="bi bi-bar-chart-fill" width="18" height="18" fill="var(--wordgamle-accent)" viewBox="0 0 448 512">
    ...
    <Container className='header-section'>
      <Row className="align-items-center py-2 justify-content-end ">
        ...
        <Col md={10} xs={9} className='d-flex justify-content-end align-items-center gap-2'>
          ...
          {/* <Link to="/groups" >
            <svg xmlns="http://www.w3.org/2000/svg" className="bi bi-people-fill" width="30" height="30" fill="var(--wordgamle-accent)"  viewBox="0 0 640 512">
          ...
          {userEmail === "cassandradroogan@gmail.com" && (
            <>
            <Link to="/admin-text">
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="var(--wordgamle-accent)" viewBox="0 0 512 512">
            ...
            <Link to="/users-list">
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="var(--wordgamle-accent)" viewBox="0 0 640 512">

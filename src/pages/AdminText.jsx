...
// Quill's color/background pickers don't support typing a custom hex value -
// only clicking a swatch - so the brand purple is added as an extra swatch
// alongside Quill's own default palette (an empty array, `{ color: [] }`,
// just means "use Quill's built-in default list").
const QUILL_DEFAULT_COLORS = [
...
const BRAND_PURPLE = '#330072';
const QUILL_COLORS_WITH_BRAND = [...QUILL_DEFAULT_COLORS, BRAND_PURPLE];

const quillModules = {
  toolbar: [
    [{ header: [1, 2, false] }],
    ['bold', 'italic', 'underline', 'strike'],
    [{ color: QUILL_COLORS_WITH_BRAND }, { background: QUILL_COLORS_WITH_BRAND }],
